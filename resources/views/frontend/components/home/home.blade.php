			...
			<div class="col-lg-12 col-sm-12 col-md-12 slider-wrap">
	               ...
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="frontend/images/slider/slider1.jpg" alt="" class="img-fluid">
							</a>
						</div>
	            ...
	            <div class="slider-item">
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="frontend/images/slider/slider2.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
	            ...
	            <div class="slider-item">
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="frontend/images/slider/slider3.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
...
<section class="section-padding">
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="blog-single.html">
				<img src="frontend/images/news/f9.jpg" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="blog-single.html">
				<img src="frontend/images/news/f10.jpg" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Experience</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="blog-single.html">
				<img src="frontend/images/news/f11.jpg" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="blog-single.html">
				<img src="frontend/images/news/f12.jpg" alt="" class="img-fluid w-100">
			</a>
			<span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
